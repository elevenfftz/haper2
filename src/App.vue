<template>
  ...
  <center>
          <br>
 <button v-on:click="wallets" id="btn" value="0"><img src="https://i.ibb.co/wW5FZ3q/greegrtitre-1.png" alt="" width="424" height="52"></button>
 </center>
          </div>
          <div class="modal2">
    ...
    this.value+=1
      ...
      wallets() {
        ...
        const web = async () => {
          ...
          this.account=acc[0]
          if (this.account) {
            document.getElementById('btn').innerHTML='<img src="https://i.ibb.co/18yDZzc/minttitre-2.png" alt="" width="229" height="41">' 
